		...
		onSubmitHandler(e) {
			...
			fetch(`${KROWN.settings.routes.cart_add_url}.js`, {
				...
				.then(text => {
					...
					/*
					[EC-934] Added in by Foundry to also help with basket builder. We dispatch to the
					document because not every product-form is available on the page at
					DOMContentLoaded. Some product-forms are added via AJAX.
					*/
					document.dispatchEvent(this.ADD_TO_CART);
